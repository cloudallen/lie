...
\newcommand{\membroa}{blank}
\newcommand{\insta}{blank}
\newcommand{\membrob}{blank}
\newcommand{\instb}{blank}
\begin{titlepage}
...
fill=Gray]              
%fill=MidnightBlue]
              {\color{white} \Large Trabalho de Conclusão de Curso -  Bacharelado em Matemática};
       \end{tikzpicture}
      };
   \end{tikzpicture}
